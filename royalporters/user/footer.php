<!--<footer  class="page-footer font-small lighten-3 py-4 mb-3" style="background-color:black;">-->
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <h5 class="font-weigth-bold text-uppercase mb-4" style="color:	#FF69B4">ABOUT US</h5>

        <p class="text-white text-muted"><?= $row['about_details']; ?></p>
      ...
      <div class="col-md-3 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <h5 class="font-weigth-bold text-uppercase mb-4" style="color:	#FF69B4">SUPPORT</h5>
      ...
      <div class="col-md-3 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <h5 class="font-weigth-bold text-uppercase mb-4" style="color:	#FF69B4">GET IN TOUCH</h5>

        <ul class="list-unstyled">

          <li>
            <p><a href="contact.php" class="fas fa-map-marker text-muted" style="text-decoration:none;color:#e6e6e6">&nbsp; -1.28588 36.9841</a></p>
          </li>
          <li>
            <p><a href="contact.php" class="fas fa-home text-muted" style="text-decoration:none;color:#e6e6e6">&nbsp; Utawala Shooters</a></p>
          </li>
          <li>
            <p><a href="contact.php" class="fas fa-phone text-muted" style="text-decoration:none;color:#e6e6e6">&nbsp; 0700000000</a></p>
          </li>
          <li>
            <p><a href="contact.php" class="fas fa-envelope text-muted" style="text-decoration:none;color:#e6e6e6">&nbsp; joelrupiah@gmail.com</a></p>
          </li>
      ...
      <div class="col-md-3 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1 text-center">
        ...
        <h5 class="font-weigth-bold text-uppercase mb-4" style="color:	#FF69B4">FOLLOW US</h5>
  ...
  <div class="container-fluid mt-0 mb-3 text-center" style="background-color:	#FF69B4;height:50px">
    <p class="text-white font-weight-bold mt-3">&copy Royal Porters, 2020</p>
  </div>
...
// Details button 
 ...
 /* $("#product_modal").hover(function(){
  ...
  //category product display revisit
